...
tests[1000] = Intersect.new(VerticalLine.new(ONE), LineSegment.new(ONE, ONE, ONE, FOUR)).eval_prog([]) == LineSegment.new(ONE, ONE, ONE, FOUR)
...
tests[720] = equal(Intersect.new(LineSegment.new(TWO, ZERO, TWO, FOUR), LineSegment.new(-FOUR, -FOUR, FOUR, FOUR)).preprocess_prog.eval_prog([]), Point.new(TWO, TWO))
...
tests[21327] = Intersect.new(LineSegment.new(0, 7, 0, 16), LineSegment.new(0, 1, 0, 4)).preprocess_prog.eval_prog([]).class == NoPoints.new.class
